...
export const DESKTOP_ITEMS = ["ABOUT", "SERVICES", "TEAM", "CAREERS", "CLIENTS", "CONTACT"];

export const FOOTER_DESKTOP_ITEMS = ["About", "Services", "Team", "Careers", "Clients", "Contact"];

export const FOOTER_TERMS_AND_CONDS = [
  "Privacy",
  "Terms of Services",
  "Notice of Filing",
