...
export const TermsOfServicePage = React.memo(() => (
  <Wrapper>
    <div>
      <p>Randiantech Terms Of Service</p>
      <WrapperText>
        ...
        <p>
          The randiantech.com website located at randiantech.com is a
          copyrighted work belonging to Randiantech. Certain features of the
        ...
        <p>
          ...
          the Company should be sent to: Carlos Pellegrini 965. After the Notice
        ...
        <p>Address: Carlos Pellegrini 965</p>
        <p>Email: info@randiantech.com</p>
      </WrapperText>
    </div>
  </Wrapper>
));
