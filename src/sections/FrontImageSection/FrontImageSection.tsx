...
export default class FrontImageSection extends React.Component<any, FrontImageState> {
      ...
      >
        <span>
          ...
          <span className="front-image-section-content-text">
            ...
            <span className="front-image-section-instantly-loved-text">INSTANTLY LOVED</span> software.
          </span>
        </span>
      </div>
    );
    ...
    return (
      <div className="front-image-section-container">
        <img
          ...
          src={isMobile ? "/images/front/office-mobile.jpg" : "/images/front/office-desktop.jpg"}
        />
        {this.renderContent()}
      </div>
    );
